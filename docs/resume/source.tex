...
\section{Achievements}
  \begin{itemize}[leftmargin=*]
      \itemsep-0.15em
      \chrono {Holding \textbf{Department Rank 1} among the dual degree students of E\&ECE department}{May 2021}
 ...
 \section{Relevant Coursework}
  \resumeSubHeadingListStart
    \resumeSubItem{Completed with Laboratory Component}
      {Algorithms, Programming and Data Structures, Digital Signal Processing, Communication Systems}
    \resumeSubItem{Completed}
      {Machine Learning, Probability and Stochastic Processes, Matrix Algebra, Speech Processing, Control Theory}
  \resumeSubHeadingListEnd

...
{Algorithms (T/L), Machine Learning (T), Programming and Data Structures (T/L), Neural Networks (T), \\Probability and Stochastic Processes (T), Matrix Algebra (T), Speech Processing (T/L)}  
\end{changemargin}

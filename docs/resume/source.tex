...
\section{Other Projects}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \item {Used BeautifulSoup for scraping and NetworkX for extracting the nested structure of posts}
      \end{itemize}
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Libraries / Frameworks}
      {TensorFlow, Keras, Scikit-learn, Pandas, LIME, BeautifulSoup, NetworkX}

...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingNew
      ...
      {\textit{Bachelor and Master of Technology (Dual Degree);  GPA} 9.47 / 10}{\textit{Jul 2018 - May 2023 (Expected)}}{\textit{Major: Electronics and Communication Engineering; Minor: Computer Science}}{}
    \resumeSubheading
      {Shah Faiz Public School}{Ghazipur, India}
      {\textit{All India Senior School Certificate Examination; Marks} 94.8\%}{\textit{May 2017}}
    \resumeSubheading
      {Shah Faiz Public School}{Ghazipur, India}
      {\textit{All India Secondary School Examination; GPA} 10 / 10}{\textit{May 2015}}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\textit{Guide | Prof. Mainack Mondal and Prof. Animesh Mukherjee}}{\textit{Natural Language Processing}}
      \begin{itemize}
          \itemsep-0.15em
          \item {Developing models that could predict whether the following comment will incur ad-hominem fallacy or not, given the sequence of preceding comments in the thread}
          \item {Currently, working on GAN-BERT that extends the fine-tuning of BERT-like architectures with unlabeled data in a generative adversarial setting}
    ...
    \resumeSubheading
      ...
      {\textit{Guide | Prof. Debasis Samanta}}{\textit{Machine Learning}}
      \begin{itemize}
          \itemsep-0.15em
...
\section{Achievements}
  \begin{itemize}[leftmargin=*]
      ...
      \chrono {Acquired \textbf{Rank 832 (Round A)} in Google Kick Start 2021}{Mar 2021}
